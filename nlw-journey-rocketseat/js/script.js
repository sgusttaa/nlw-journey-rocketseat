...
const criarItemDeAtividade = (atividade) => {
    ...
    <!--invoca a data curta usando a class short-->
    <time class='short'>
    ...
    <!--invoca a data longa usando a class full-->
...
const salvarAtividade = (event) => {
    ...
    if(atividadeExiste){
        return alert("Dia/Hora não dísponivel")
    }
...
const concluirAtividade= (event) => {
    ...
    //se atividade era falso vira verdadeiro e vice versa
